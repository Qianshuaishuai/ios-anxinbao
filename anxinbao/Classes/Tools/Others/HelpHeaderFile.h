...
#define StandardWidth 375
#define UIScaleRatio (MainScreenWidth/StandardWidth)
...
#define ThemeColor UIColorFromRGB(0x2facae)
#define BGCOLOR UIColorFromRGB(0xf0f0f0)
#define TabBarSelectColor UIColorFromRGB(0x252729)
#define TabBarUnSelectColor UIColorFromRGB(0xbbbbbb)
